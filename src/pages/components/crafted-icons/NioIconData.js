...
export const fileManagerIconData = [
  {
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 72 72">
        ...
        ></path>
        <path fill="#0069FF" d="M7.7 59c2.2 2.4 4.7 2 6.3 2h45c1.1 0 3.2.1 5.3-2H7.7z"></path>
      </svg>
    ),
    name: "Folder",
  },
  {
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
        ...
        ></path>
        <path fill="#0069FF" d="M8.015 59c2.169 2.383 4.698 2.016 6.195 2h44.57a6.277 6.277 0 005.207-2z"></path>
        <path
          fill="#4b66bc"
    ...
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
        ...
        <path
          ...
          d="M59.778 61H12.222A6.421 6.421 0 016 54.396V17.604A6.421 6.421 0 0112.222 11h18.476a4.671 4.671 0 014.113 2.564L38 24h21.778A5.91 5.91 0 0166 30v24.396A6.421 6.421 0 0159.778 61z"
        ></path>
        <path fill="#0069FF" d="M7.745 58.98C9.935 61.387 12.488 61.017 14 61h45a6.337 6.337 0 005.256-2.02z"></path>
        <path
          fill="#4b66bc"
